...
;(function(undefined) {
  ...
  function skipUnknownField(buffer, type) {
    switch (type) {
      case 0:
        while (buffer.readByte() & 0x80) {
        }
        break
      case 2:
        buffer.skip(buffer.readVarint32())
        break
      case 5:
        buffer.skip(4)
        break
  ...
  function coerceLong(value) {
    if (
      !(value instanceof ByteBuffer.Long) && 'low' in value && 'high' in value
    )
  ...
  types['encodeRequest'] = function(message) {
    ...
    // optional RequestDeliverTx deliver_tx = 5;
    ...
    // optional RequestCheckTx check_tx = 6;
    ...
    // optional RequestCommit commit = 7;
    ...
    // optional RequestInitChain init_chain = 9;
    ...
    // optional RequestBeginBlock begin_block = 10;
  ...
  types['encodeRequestEcho'] = function(message) {
    ...
    if (value !== undefined) {
      ...
      nested.writeUTF8String(value), buffer.writeVarint32(
        nested.flip().limit
  ...
  types['decodeRequestBeginBlock'] = function(buffer) {
    ...
    end_of_message: while (buffer.remaining() > 0) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          var values =
            message['absent_validators'] || (message['absent_validators'] = [])
          if ((tag & 7) === 2) {
  ...
  types['encodeResponse'] = function(message) {
    ...
    // optional ResponseDeliverTx deliver_tx = 6;
    var value = message['deliver_tx']
    if (value !== undefined) {
      buffer.writeVarint32(50)
    ...
    // optional ResponseCheckTx check_tx = 7;
    var value = message['check_tx']
    if (value !== undefined) {
      buffer.writeVarint32(58)
    ...
    // optional ResponseCommit commit = 8;
    var value = message['commit']
    if (value !== undefined) {
      buffer.writeVarint32(66)
    ...
    // optional ResponseQuery query = 9;
    var value = message['query']
    if (value !== undefined) {
      buffer.writeVarint32(74)
    ...
    // optional ResponseInitChain init_chain = 10;
    var value = message['init_chain']
    if (value !== undefined) {
      buffer.writeVarint32(82)
    ...
    // optional ResponseBeginBlock begin_block = 11;
    var value = message['begin_block']
    if (value !== undefined) {
      buffer.writeVarint32(90)
    ...
    // optional ResponseEndBlock end_block = 12;
    var value = message['end_block']
    if (value !== undefined) {
  ...
  types['decodeResponseInfo'] = function(buffer) {
    ...
    end_of_message: while (buffer.remaining() > 0) {
      ...
      switch (tag >>> 3) {
        ...
        // optional bytes last_block_app_hash = 4;
        case 4:
          message['last_block_app_hash'] = buffer
            .readBytes(buffer.readVarint32())
            .toBuffer()
          break
  ...
  types['decodeResponseEndBlock'] = function(buffer) {
    ...
    end_of_message: while (buffer.remaining() > 0) {
      ...
      switch (tag >>> 3) {
        ...
        case 1:
          var limit = pushTemporaryLength(buffer)
          var values = message['diffs'] || (message['diffs'] = [])
          values.push(types['decodeValidator'](buffer))
          buffer.limit = limit
          break
  ...
  types['decodeHeader'] = function(buffer) {
    ...
    end_of_message: while (buffer.remaining() > 0) {
      ...
      switch (tag >>> 3) {
        ...
        // optional string chain_id = 1;
        case 1:
          message['chain_id'] = buffer.readUTF8String(
            buffer.readVarint32(),
            'b'
          )
          break
        ...
        // optional bytes last_commit_hash = 6;
        case 6:
          message['last_commit_hash'] = buffer
            .readBytes(buffer.readVarint32())
            .toBuffer()
          break
        // optional bytes data_hash = 7;
        case 7:
          message['data_hash'] = buffer
            .readBytes(buffer.readVarint32())
            .toBuffer()
          break
        // optional bytes validators_hash = 8;
        case 8:
          message['validators_hash'] = buffer
            .readBytes(buffer.readVarint32())
            .toBuffer()
          break
        // optional bytes app_hash = 9;
        case 9:
          message['app_hash'] = buffer
            .readBytes(buffer.readVarint32())
            .toBuffer()
          break
  ...
  types['decodeKVPair'] = function(buffer) {
    ...
    end_of_message: while (buffer.remaining() > 0) {
      ...
      switch (tag >>> 3) {
        ...
        // optional string value_string = 3;
        case 3:
          message['value_string'] = buffer.readUTF8String(
            buffer.readVarint32(),
            'b'
          )
          break
