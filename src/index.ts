...
function lotion (config: lotion.ApplicationConfig): any  {
	return new lotion.Lotion(config)
}
...
namespace lotion {
	...
	export class Lotion implements Application {
		...
		readonly logTendermint: boolean
		private home: string
